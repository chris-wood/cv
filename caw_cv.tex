...
Computer and network security and privacy, network architectures and protocols, 
cryptographic algorithms and engineering, and software engineering. \\
...
\begin{enumerate}[D-1.]
    % TODO(caw): DNS privacy option, DOH privacy extension, Noise+QUIC, TLS ticket requests, TLS blind session tickets, SKSS 1.3
    % TODO(caw): add new TAPS drafts
...
\item ``A Survey of Transport Security Protocols,'' presentation, IETF TAPS Meeting, London. March 21, 2018.

\item ``Hashing to Elliptic Curves,'' presentation, IRTF CFRG Meeting, London. March 19, 2018.

\item ``Randomness Improvements for Security Protocols,'' presentation, IRTF CFRG Meeting, London. March 19, 2018.

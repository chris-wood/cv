...
Rochester, NY 14620 & 315-806-5939 \\
\end{tabular*}}
\\
...
\begin{itemize}
\item
	\ressubheading{Keyboard Biometric-Based Continuous Authentication System}{RIT}{Intelligent Security Systems, Machine Learning}{September 2012 - present}
	\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{center}\begin{longtable}{l@{\extracolsep{\fill}}r}
		...
		\multicolumn{2}{c}{RIT Intramural Flag Football Team \cftdotfill{\cftdotsep} Fall 2010}\\
...
\item
	Programming Languages: C/C++, C\#, Java, Python, Ruby, Assembly (MIPS), Javascript, Scheme
%	\begin{itemize} 
%		\resitem{}
%	\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{compactitem}
\item Born in Syracuse, NY
\item Son of Robert and Jill Wood
